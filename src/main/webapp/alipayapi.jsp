...
<html>
	...
	//payment amount in foreign currency ,not null
        ...
        //String rmb_fee = new String(request.getParameter("WIDrmb_fee").getBytes("ISO-8859-1"),"UTF-8");
        //商品描述，可空
	...
	//product_code,not null
        ...
        String timeout_rule = new String(request.getParameter("WIDtimeout_rule").getBytes("ISO-8859-1"),"UTF-8");
       // String supplier = new String(request.getParameter("WIDsupplier").getBytes("ISO-8859-1"),"UTF-8");
		...
		sParaTemp.put("timeout_rule", timeout_rule);
