    ...
    <div class="content">
		...
		Remarks: Settlement currency that merchants signed with Alipay, like USD</div>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDtotal_fee" value="30"></div>
                <br>
		...
		Remarks:Mandatory.For PC: NEW_OVERSEAS_SELLER ;FOR WAP and APP: NEW_WAP_OVERSEAS_SELLER</div>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDsplit_fund_info" value='[{"transIn":"2088621891276664","amount":"0.10","currency":"USD","desc":"Split _test1"}]'></div>
                <br>
                <div class="mark">注意：[{"transIn":"2088621891276664","amount":"0.10","currency":"USD","desc":"Split _test1"}]</div>
            </div>
 <div class="element">
                <div class="etitle">timeout_rule:</div>
                <div class="einput"><input type="text" name="WIDtimeout_rule" value="12h"></div>
                <br>
                <div class="mark">注意：默认值为12h</div>
            </div>
            <div class="element">
